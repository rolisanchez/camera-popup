...
class CameraViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // move it up! and shrink control
        let moveitup = CGFloat(100.0)
        let shrinkwidth = CGFloat(20.0+20.0) //each side
        //
        self.controlDockView = UIView(frame: CGRect(x: 0, y: screenBounds.height - controlDockHeight - moveitup, width: screenBounds.width - shrinkwidth, height: controlDockHeight))
